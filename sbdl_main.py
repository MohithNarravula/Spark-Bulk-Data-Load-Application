...
# Forces Spark workers to use the exact Python (3.11) running this script
...
if __name__ == '__main__':
    ...
    # Here Since your data is nested (a struct within a struct),
    # you use payload.contractIdentifier.newValue to "reach inside" the
    # layers and grab just the account ID.
